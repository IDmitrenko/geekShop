 ...
 * 2020-04-14T16:41:34.583+03:00
 * Generated source version: 3.1.10
 * 
 */
@WebServiceClient(name = "PaymentPortService", 
                  wsdlLocation = "file:/E:/GeekBrains/Spring2/geekShop/src/main/resources/META-INF/wsdl/payment/WsPayment.wsdl",
...
public class PaymentPortService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/GeekBrains/Spring2/geekShop/src/main/resources/META-INF/wsdl/payment/WsPayment.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PaymentPortService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/E:/GeekBrains/Spring2/geekShop/src/main/resources/META-INF/wsdl/payment/WsPayment.wsdl");
        }
        WSDL_LOCATION = url;
    }
